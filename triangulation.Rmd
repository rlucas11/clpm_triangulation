...
Step 3: Difference Test       The coefficient for X1 predicting  Negative coefficients can be expected
                              the difference between Y2 and Y1   for true causal effects when X1 and Y1
                              should be 0 or positive            are correlated (see Figure 3)
-------------------------------------------------------------------------------------------------------
...
final_agg %>%
    ...
    mutate(Stability = as.factor(Stability)) %>%
...
A preprint of this paper was posted on the PsyArXiv preprint server:  https://osf.io/u49q5/.
